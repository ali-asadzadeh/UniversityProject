...
<section>
    <div class="grid place-content-center h-screen bg-gray-50">
        ...
        <div class="bg-white border rounded-lg block w-96 mx-auto">
            ...
            <form class="space-y-6 px-5 pb-3" action="{{ route('password.email') }}" method="POST">
                @csrf
                <div>
                ...
                <div class="">
                    <button type="submit" class="flex w-full justify-center rounded-md px-3 py-1.5 text-sm font-semibold leading-6 shadow-sm text-white bg-[#5CAF90] hover:bg-[#4A9C7E] focus:ring-4 focus:outline-none focus:ring-[#4A9C7E]">ارسال لینک بازیابی</button>
                </div>
            </form>
        </div>
    </div>
