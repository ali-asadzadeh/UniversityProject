            ...
            @csrf
                ...
                <div class="grid gap-5 grid-cols-2 mt-5">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="rating" name="rating" type="number" value="{{ old('rating', $post->rating) }}" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:outline-none focus:ring-[#4A9C7E] sm:text-sm sm:leading-6">
                        </div>
                    </div>
                </div>
                <div class="grid gap-5 grid-cols-2 mt-5">
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="date" name="date" type="date" value="{{ old('date', $post->date) }}" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:outline-none focus:ring-[#4A9C7E] sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            @if ($post->image && file_exists(storage_path('app/public/' . $post->image)))
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $post->image) }}" alt="Product Image" class="w-20 h-auto">
                                </div>
                            @else
